...
return array(
	...
	'allow_close_questions' => 'Allow articles to be manually closed:',
	'allow_close_own_questions' => 'Allow users to close their own articles:',
	'allow_login_email_only' => 'Only log in by email address (not username):',
	'allow_multi_answers' => 'Allow multiple replys per user:',
	'allow_no_category' => 'Allow articles with no category',
	'allow_no_sub_category' => 'Allow articles with a category but no sub-category',
	'allow_private_messages' => 'Enable private messaging between users:',
	'allow_self_answer' => 'Allow users to reply their own article:',
	'allow_user_walls' => 'Enable wall posts on user profiles:',
	'allow_view_q_bots' => 'Allow search engines to view article pages',
	...
	'avatar_q_list_size' => 'Avatar size on article lists:',
	'avatar_q_page_a_size' => 'Avatar size on replys:',
	'avatar_q_page_c_size' => 'Avatar size on comments:',
	'avatar_q_page_q_size' => 'Avatar size on articles:',
	...
	'caching_q_start' => 'Start caching articles after:',
	'caching_q_time' => 'Cache article pages for:',
	'caching_qlist_time' => 'Cache article lists for:',
	...
	'comment_on_as' => 'Allow comments on replys:',
	'comment_on_qs' => 'Allow comments on articles:',
	...
	'default_sidebar' => 'Welcome to ^, where you can ask articles and receive replys from other members of the community.',
	'default_subject' => 'A message from ^',
	'default_suffix' => 'Q&A',
	'default_terms' => 'I agree to the ^ Terms & Conditions and Privacy Policy',
	'do_ask_check_qs' => 'Check for similar articles when asking:',
	'do_close_on_select' => 'Close articles with a selected reply:',
	'do_complete_tags' => 'Show matching tags while typing:',
	'do_count_q_views' => 'Count the number of article views:',
	'do_example_tags' => 'Show example tags based on article:',
	'editor_for_as' => 'Default editor for replys:',
	'editor_for_cs' => 'Default editor for comments:',
	'editor_for_qs' => 'Default editor for articles:',
	...
	'extra_field_display' => 'Show the extra information on article pages',
	'extra_field_display_label' => 'Show the extra information on article pages with label:',
	'feed_for_activity' => 'Feed for recent activity:',
	'feed_for_hot' => 'Feed for hot articles:',
	'feed_for_qa' => 'Feed for recent articles and replys:',
	'feed_for_questions' => 'Feed for recent articles:',
	'feed_for_search' => 'Feeds for search results:',
	'feed_for_tag_qs' => 'Feed for each tag\'s articles:',
	'feed_for_unanswered' => 'Feed for unreplyed articles:',
	...
	'follow_on_as' => 'Allow articles to be related to replys:',
	'from_email' => 'Sender address for messages from site:',
	'hot_weight_a_age' => 'Article has a new reply:',
	'hot_weight_answers' => 'Article has many replys:',
	'hot_weight_q_age' => 'Article is new:',
	'hot_weight_views' => 'Article has many views:',
	'hot_weight_votes' => 'Article has many up votes:',
	...
	'match_4' => 'Wider',
	'match_5' => 'Widest',
	'match_ask_check_qs' => 'Similar articles matching:',
	'match_example_tags' => 'Example tags matching:',
	'match_related_qs' => 'Related articles matching:',
	'max_len_q_title' => 'Maximum length of article title:',
	'max_num_q_tags' => 'Maximum number of tags:',
	'max_rate_ip_as' => 'Rate limit for adding replys:',
	...
	'max_rate_ip_qs' => 'Rate limit for asking articles:',
	...
	'max_rate_user_as' => 'Maximum replys per user per hour:',
	...
	'max_rate_user_qs' => 'Maximum articles per user per hour:',
	...
	'min_len_q_content' => 'Minimum length of article body:',
	'min_len_q_title' => 'Minimum length of article title:',
	...
	'notify_admin_q_post' => 'Email this address when a article is posted',
	'notify_users_default' => 'Check email notification box by default:',
	'option_default' => 'Default',
	'page_size_activity' => 'Length of All Activity page:',
	'page_size_ask_check_qs' => 'Maximum similar articles to show:',
	...
	'page_size_q_as' => 'Maximum replys per page:',
	'page_size_qs' => 'Length of Articles page:',
	'page_size_related_qs' => 'Maximum related articles:',
	'page_size_search' => 'Search results per page:',
	'page_size_tag_qs' => 'Articles on each tag page:',
	'page_size_tags' => 'Length of Tags page:',
	'page_size_una_qs' => 'Length of Unreplyed page:',
	...
	'points_per_q_voted_down' => 'Per down vote on your article:',
	'points_per_q_voted_up' => 'Per up vote on your article:',
	'points_post_a' => 'Posting an reply:',
	'points_post_q' => 'Posting a article:',
	'points_q_voted_max_gain' => 'Limit from up votes on each article:',
	'points_q_voted_max_loss' => 'Limit from down votes on each article:',
	'points_select_a' => 'Selecting an reply for your article:',
	'points_vote_down_a' => 'Voting down an reply:',
	'points_vote_down_q' => 'Voting down a article:',
	'points_vote_up_a' => 'Voting up an reply:',
	'points_vote_up_q' => 'Voting up a article:',
	'q_urls_remove_accents' => 'Remove accents from article URLs:',
	'q_urls_title_length' => 'Article title length in URLs:',
	'recalc_hotness_q_view' => 'Recalculate hotness on every article page view:',
	...
	'show_view_count_q_page' => 'Show view count on article pages:',
	'show_view_counts' => 'Show view count in article lists:',
	...
	'voting_on_as' => 'Allow voting on replys:',
	'voting_on_cs' => 'Allow voting on comments:',
	'voting_on_q_page_only' => 'Allow voting on article page only:',
	'voting_on_qs' => 'Allow voting on articles:',
);
