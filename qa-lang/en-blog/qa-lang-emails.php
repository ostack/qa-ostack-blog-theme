...
return array(
	...
	'a_followed_body' => "Your reply on ^site_title has a new related article by ^q_handle:\n\n^open^q_title^close\n\nYour reply was:\n\n^open^a_content^close\n\nClick below to reply the new article:\n\n^url\n\nThank you,\n\n^site_title",
	'a_followed_subject' => 'Your ^site_title reply has a related article',
	...
	'q_answered_body' => "Your article on ^site_title has been replyed by ^a_handle:\n\n^open^a_content^close\n\nYour article was:\n\n^open^q_title^close\n\nIf you like this reply, you may select it as the best:\n\n^url\n\nThank you,\n\n^site_title",
	'q_answered_subject' => 'Your ^site_title article was replyed',

	'q_commented_body' => "Your article on ^site_title has a new comment by ^c_handle:\n\n^open^c_content^close\n\nYour article was:\n\n^open^c_context^close\n\nYou may respond by adding your own comment:\n\n^url\n\nThank you,\n\n^site_title",
	'q_commented_subject' => 'Your ^site_title article has a new comment',

	'q_posted_body' => "A new article has been asked by ^q_handle:\n\n^open^q_title\n\n^q_content^close\n\nClick below to see the article:\n\n^url\n\nThank you,\n\n^site_title",
	'q_posted_subject' => '^site_title has a new article',
